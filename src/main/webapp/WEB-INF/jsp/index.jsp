...
<body>
	...
	<section id="banner">
		<div class="inner">
			<header>
				<h1>For Next Step</h1>
				<p>Home IoT system utilizing Bigdata...</p>
			</header>
			<a href="#main" class="button big scrolly">More Info</a>
		</div>
	</section>
						...
						<div class="inner">
							<div class="flex flex-2">
								...
								<div class="col col1 first">
									<div class="image round fit">
										<a href="generic.html" class="link"><img src="${pageContext.servletContext.contextPath}/images/bigdata01.jpg" alt="" /></a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="inner">
							...
							<div class="flex flex-3">
								<div class="col align-center">
									...
									<a href="store_info.html" class="button">자세히 보기</a>
								</div>
								<div class="col align-center">
									<div class="image round fit">
									...
									<a href="generic.html" class="button">자세히 보기</a>
								</div>
								<div class="col align-center">
									<div class="image round fit">
